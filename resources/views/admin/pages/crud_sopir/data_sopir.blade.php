                    ...
                    <div class="card-body">
                        <div class="py-5">
                                ...
                                <div class=" col-lg-4">
                                    <div class="card py-4 ">
                                        <div class="card-body text-center">
                                            <img src="{{ asset('admin/images/faces/face4.jpg') }}" alt="avatar"
                            ...
                            <div class="d-flex justify-content-center ">
                                <a href="/add-sopir"><button type="button" class="btn"
                                        style="background-color: #FD5D3B;color:#fff">CLOSE</button></a>
                            </div>
                        </div>
                    </div>
                </div>
