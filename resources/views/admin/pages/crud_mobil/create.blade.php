                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="/create-mobil" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input name="tahun" type="text" class="form-control  rounded-pill"
                                    id="exampleInputName1" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleSelectGender">Kapasitas Penumpang<span
                                        class="text-danger">*</span></label>
                                <input name="kapasitas_orang" type="text" class="form-control  rounded-pill"
                                    id="exampleInputName1" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="kapasitas_mesin" type="text" class="form-control  rounded-pill"
                                    id="exampleInputName1" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputName1">Harga Sewa/Hari<span class="text-danger">*</span></label>
                                <input name="harga_sewa" type="text" class="form-control  rounded-pill"
                                    id="exampleInputName1" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputName1">Fitur Tersedia<span class="text-danger">*</span></label><br>
                                <label for="pilihan1">
                                    <input type="checkbox" id="pilihan1" name="fitur_tersedia[]" value="Air Conditioner">
                                    Air Conditioner
                                </label>

                                <label for="pilihan2">
                                    <input type="checkbox" id="pilihan2" name="fitur_tersedia[]"
                                        value="Reverse Parking Camera"> Reverse Parking Camera
                                </label>
                                <label for="pilihan3">
                                    <input type="checkbox" id="pilihan1" name="fitur_tersedia[]" value="Post Change">
                                    Post Change
                                </label>

                                <label for="pilihan4">
                                    <input type="checkbox" id="pilihan2" name="fitur_tersedia[]"
                                        value="Anti-lock Breaking System"> Anti-lock Breaking System
                                </label>
                                <label for="pilihan5">
                                    <input type="checkbox" id="pilihan1" name="fitur_tersedia[]"
                                        value="Aux-in,Radio,DVD,CD,Mp3"> Aux-in,Radio,DVD,CD,Mp3
                                </label>

                                <label for="pilihan6">
                                    <input type="checkbox" id="pilihan2" name="fitur_tersedia[]"
                                        value="Reclining Seat"> Reclining Seat
                                </label>

                                <label for="pilihan7">
                                    <input type="checkbox" id="pilihan2" name="fitur_tersedia[]"
                                        value="Side Impact Beam"> Side Impact Beam
                                </label>
                            </div>
                            <div class="form-group">
                            ...
                            <a href="/data-mobil" class="btn border"
                                style="background-color: #fff;color:#000000">CLOSE</a>
                        </form>
                    </div>
                </div>
            </div>
