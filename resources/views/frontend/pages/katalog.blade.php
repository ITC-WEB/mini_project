    ...
    <div class="container">
        <div class="row mb-3">
            ...
            <div class="col-lg-12 col-sm-12 col-md-12 d-flex justify-content-center flex-wrap pt-3  ">
                ...
                <div class="dropdown ml-2 mr-2 my-3">
                    <button class="btn btn-outline btndrop" type="button" id="dropdownMenuButton1" data-toggle="dropdown"
                ...
                @if ($mobils->status !== 1)
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-4 cardkatalog ">
                        ...
                        <div class="shadow  p-4 cardku">
                            ...
                            <div class="item">
                                <a href="#" id="disewa">
                                    <img src="{{ asset('storage/public/mobil/' . $mobils->gambar) }}" alt=""
                                        class="img-fluid">
                                </a>
                                <div class="info">
                        ...
                        <div class="shadow  p-4 cardku">
                            ...
                            <div class="item">
                                <a href="{{ route('detail', ['id' => $mobils->id]) }}">
                                    <img src="{{ asset('storage/mobil/' . $mobils->gambar) }}" alt=""
                                        class="img-fluid">
                                </a>
                                <div class="info">
                                    <h5>Name :{{ $mobils->name }} </h5>
