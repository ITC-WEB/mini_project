                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4">
                        @foreach ($mobil as $mobils)
                            <div class="card-travel text-center d-flex flex-column"
                                style="background-image: url('frontend/images/populer1.png')">
            ...
            <div class="container mb-5">
                <div class="section-popular-travel row justify-content-center match-height">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <img src="{{ asset('frontend/images/avatar-2.png') }}" alt=""
                                    class="mb-4 rounded-circle" />
            ...
            <div class="container cta mt-5 pt-5 pb-3">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 text-left">
                        ...
                        <a href="katalog.html"
                            class="btncta btn-get-started px-4 mt-5 ml-5 p-2 text-decoration-none btnpesan"> Pesan Sekarang
                        </a>
                    </div>
