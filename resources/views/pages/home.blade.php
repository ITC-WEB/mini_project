        ...
        <div class="container">
            <div class="section-popular-travel row justify-content-center">
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="card-travel text-center d-flex flex-column" style="background-image: url('/frontend/frontend/images/populer1.png')">
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="card-travel text-center d-flex flex-column" style="background-image: url('/frontend/frontend/images/populer2.png')">
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="card-travel text-center d-flex flex-column" style="background-image: url('/frontend/frontend/images/populer3.png')">
                        <div class="travel-country">Kabupaten Malang</div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 text-center">
                    <img src="/frontend/frontend/images/partner.png" class="img-patner" />
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="mt-6 mb-5 text-center">
                        <img src="/frontend/frontend/images/mengapamelih kami .jpg" class="about-image rounded">
                    </div>
                </div>
        ...
        <div class="container mb-5">
            <div class="section-popular-travel row justify-content-center match-height">
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            <img src="/frontend/frontend/images/avatar-1.png" alt="" class="mb-4 rounded-circle" />
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            <img src="/frontend/frontend/images/avatar-2.png" alt="" class="mb-4 rounded-circle" />
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content mb-auto">
                            <img src="/frontend/frontend/images/avatar-3.png" alt="" class="mb-4 rounded-circle" />
        ...
        <div class="container cta mt-5 pt-5 pb-3">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mt-5">
                    <img src="/frontend/frontend/images/cta.png" class="about-image rounded img-fluid">
                </div>
            </div>
        </div>
    </section>
